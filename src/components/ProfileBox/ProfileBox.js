        ...
        return (
            <div className="profile-box-container">
                ...
                <div className="profile-box-name-container">
                    <h1 className="profile-box-name">Scott Sutherland</h1>
                    {window.innerWidth > 1100 ?
                    <a className="linkedin-link-container" href="https://www.linkedin.com/in/suthes1/" target="_blank" rel="noopener noreferrer">
                ...
                <div className="profile-box-school-container">
                    <h1 className="profile-box-school">McMaster University | Electrical Engineering 2021</h1>
                </div>
